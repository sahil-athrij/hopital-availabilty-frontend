...
!function (global, setTimeout)
{
    ...
    function newContext(e)
    {
        ...
        function i(e, i, r)
        {
            let n, o, a, s, u, c, d, p, f, l, h = i && i.split("/"), m = y.map, g = m && m["*"];
        ...
        function l()
        {
            let e, t, i = 1e3 * y.waitSeconds, o = i && q.startTime + i < (new Date).getTime(), a = [], s = [], u = !1,
                d = !0;
            if (!x)
            {
                if (x = !0, eachProp(k, function (e)
                {
                    const i = e.map, c = i.id;
        ...
        }, b = function (e)
        {
            ...
            }, check: function ()
            {
                ...
                {
                    let e, t, i = this.map.id, r = this.depExports, n = this.exports, o = this.factory;
                    if (this.inited)
                    {
                        if (this.error)
            ...
            {
                const e = this.map, t = e.id, r = a(e.prefix);
                this.depMaps.push(r), u(r, "defined", bind(this, function (r)
                {
                    let n, o, d, f = getOwn(R, this.map.id), l = this.map.name,
                    ...
                    {
                        const o = e.name, u = a(o), d = useInteractive;
            ...
            configure: function (e)
            {
                ...
                const i = y.shim, r = {paths: !0, bundles: !0, config: !0, map: !0};
            ...
            makeRequire: function (t, n)
            {
                ...
                return n = n || {}, mixin(o, {
                    ...
                    {
                        let r, n = e.lastIndexOf("."), o = e.split("/")[0], a = "." === o || ".." === o;
            ...
            {
                let t, i, r, o = getOwn(y.shim, e) || {}, a = o.exports;
                for (d(); O.length;)
                {
                    if (null === (i = O.shift())[0])
                    {
            ...
            {
                let r, n, o, a, s, u, c, d = getOwn(y.pkgs, e);
